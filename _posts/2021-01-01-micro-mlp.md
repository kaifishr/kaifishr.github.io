...
Now let's try using the implementation above to train a fully connected neural network for a classification task. For this we use two popular datasets. The first dataset consists of two noisy intertwined spirals. The second dataset follows the distribution of a checkerboard pattern. Both datasets used for training the model consisted of 20.000 samples. The validation datasets consisted both of 4000 points. The network consisted of three hidden layers with 128 neurons each. The model was trained for 1000 epochs at a learning rate of $$\eta=1e-4$$.

<p align="center"> 
<img src="/assets/images/post7/dataset_spirals2.png" width="365">
<img src="/assets/images/post7/dataset_checkerboard.png" width="365">
</p>

## Results

The following section shows the results for the validation set.
...
<p align="center"> 
<img src="/assets/images/post7/loss.png" width="365">
<img src="/assets/images/post7/accuracy.png" width="365">
</p>
